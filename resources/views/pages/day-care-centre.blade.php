                    ...
                    <div class="col-md-10">
                        <div class="card">
                            <div class="card-body p-5">
                                <div class="lang-en">
                                    <p>
                                        For working ladies and female officers' convenience, BNFWA has the arrangement
                                        for Children's Day Care Centre.
                                    </p>
                                    <div class="row">
                                ...
                                <div class="lang-bn">
                                    <p>
                                        কর্মরত লেডি অফিসার এবং অফিসার পত্নীদের শিশু সন্তানদের জন্য ডে কেয়ার সেন্টারের
                                        ব্যবস্থা করেছে।
                                    </p>
                                </div>
                            </div>
