...
<main>
    ...
    <section class="flash-news-section">
        <div class="flash-news-wrapper swiper-container">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <a href="#"> নৌসদরের অভ্যন্তরে নিরাপদ পরিবেশে (শীতাতপ নিয়ন্ত্রিত) নিবিড় পরিচর্যায় বিএনএফডব্লিউএ
                        কর্তৃক পরিচালিত ডে কেয়ার সেন্টার Blue Wave Child Care এর শুভ উদ্বোধন করা হয়েছে। </a>
                </div>
                <div class="swiper-slide">
                    <a href="#">বিএনএফডব্লিউএ কর্তৃক পরিচালিত ঝিনুক ক্র্যাফটিং এ্যান্ড ট্রেনিং সেন্টার (জেসিএ্যান্ডটিসি)
                        চটগ্রাম এর শুভ উদ্বোধন।</a>
                </div>
                <div class="swiper-slide">
                    <a href="#">বিশেষ চাহিদা সম্পন্ন শিশুদের জন্য আশার আলো ঢাকা প্রতিষ্ঠানের অবকাঠামোগত নির্মাণ কাজ
                        চলমান রয়েছে।</a>
                </div>
                <div class="swiper-slide">
                    <a href="#">বিএনএফডব্লিউএ কর্তৃক ফেনীর ফুলগাজীতে বন্যায় ক্ষতিগ্রস্ত অসহায় পরিবারকে পুনর্বাসনের
                        কার্যক্রম চলমান রয়েছে। </a>
                </div>
            </div>
        </div>
    </section>
