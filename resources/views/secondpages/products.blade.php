...
@section('content')
    ...
    <section class="inner-page-banner">
        <div class="container">
            <div class="row">
                <div class="col">
                    <h1><span class="lang-en">Products</span> <span class="lang-bn">প্রোডাক্টস</span></h1>
                </div>
            </div>
        </div>
    </section>
    ...
    <main>
        <section class="page-section">
                ...
                <div class="row row-gap-4 justify-content-center">
                    <div class="col">
                        <div class="products-wrapper">
                            ...
                            <a class="product-item" data-bs-toggle="modal" data-bs-target="#exampleModal" href="#">
                                <img alt="বিভিনড়ব ডিজাইনের জুট ব্যাগ" src="{{ asset('assets/images/products/different-design-jute-bag.jpg') }}">
                                <div>
                                    <h3 class="h5"> বিভিন্ন ডিজাইনের জুট ব্যাগ</h3>
                                </div>
                            </a>

                            <a class="product-item" data-bs-toggle="modal" data-bs-target="#exampleModal" href="#">
                                <img alt="বেসিন তাওয়াল" src="{{ asset('assets/images/products/basin-towel.jpg') }}">
                                <div>
                                    <h3 class="h5">বেসিন তাওয়াল</h3>
                                </div>
                            </a>

                            <a class="product-item" data-bs-toggle="modal" data-bs-target="#exampleModal" href="#">
                                <img alt="হাত পার্স" src="{{ asset('assets/images/products/hand-purse.jpg') }}">
                                <div>
                                    <h3 class="h5">হাত পার্স</h3>
                                </div>
                            </a>

                            <a class="product-item" data-bs-toggle="modal" data-bs-target="#exampleModal" href="#">
                                <img alt="কসমেটিক কীট ব্যাগ" src="{{ asset('assets/images/products/cosmetic-kit-bag.jpg') }}">
                                <div>
                                    <h3 class="h5">কসমেটিক কীট ব্যাগ</h3>
                                </div>
                            </a>

                            <a class="product-item" data-bs-toggle="modal" data-bs-target="#exampleModal" href="#">
                                <img alt="ব্যাগ হোল্ডার" src="{{ asset('assets/images/products/bag-holder.jpg') }}">
                                <div>
                                    <h3 class="h5">ব্যাগ হোল্ডার</h3>
                                </div>
                            </a>

                            <a class="product-item" data-bs-toggle="modal" data-bs-target="#exampleModal" href="#">
                                <img alt="স্যু হোল্ডার" src="{{ asset('assets/images/products/shoe-holder.jpg') }}">
                                <div>
                                    <h3 class="h5">স্যু হোল্ডার</h3>
                                </div>
                            </a>

                            <a class="product-item" data-bs-toggle="modal" data-bs-target="#exampleModal" href="#">
                                <img alt="নামাজের হিজাব" src="{{ asset('assets/images/products/prayer-hijab.jpg') }}">
                                <div>
                                    <h3 class="h5">নামাজের হিজাব</h3>
                                </div>
                            </a>

                            <a class="product-item" data-bs-toggle="modal" data-bs-target="#exampleModal" href="#">
                                <img alt="বেবি হিজাব" src="{{ asset('assets/images/products/baby-hijab.jpg') }}">
                                <div>
                                    <h3 class="h5">বেবি হিজাব</h3>
                                </div>
                            </a>

                            <a class="product-item" data-bs-toggle="modal" data-bs-target="#exampleModal" href="#">
                                <img alt="কিচেন এপ্রোন" src="{{ asset('assets/images/products/kitchen-apron.jpg') }}">
                                <div>
                                    <h3 class="h5">কিচেন এপ্রোন</h3>
                                </div>
                            </a>

                            <a class="product-item" data-bs-toggle="modal" data-bs-target="#exampleModal" href="#">
                                <img alt="বাটার ফ্লাই ব্যাগ" src="{{ asset('assets/images/products/butterfly-bag.jpg') }}">
                                <div>
                                    <h3 class="h5">বাটার ফ্লাই ব্যাগ</h3>
                                </div>
                            </a>
            ...
            <div class="row">
                <div class="col">
                    <div class="modal fade product-inquiry-modal" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
